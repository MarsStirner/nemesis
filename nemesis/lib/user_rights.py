...
# event
urEventClinicCreate = u'evtClinicCreate'  # Имеет возможность создавать обращения в дневной стационар
urEventHospitalCreate = u'evtHospitalCreate'  # Имеет возможность создавать обращения в круглосуточный стационар
...
urEventClinicClose = u'evtClinicClose'  # Имеет возможность закрывать обращения в дневной стационар
urEventHospitalClose = u'evtHospitalClose'  # Имеет возможность закрывать обращения в круглосуточный стационар
