    ...
    .run(['$templateCache', function ($templateCache) {
        ...
        $templateCache.put('/WebMis20/wysiwyg-toolbar.html',
            '<div class="btn-toolbar" data-role="editor-toolbar" data-target="#editor">\
                ...
                <div class="btn-group">\
                    <a class="btn" wysiwyg-open-symbols ng-if="symbolsCode"><i class="fa">Спецсимволы <i class="fa fa-calculator"></i></i></a>\
                </div>\
        ...
        $templateCache.put('/WebMis20/aside-symbols/groups.html',
            ...
            <wysiwyg ng-model="model.text" get-wysiwyg-api="getWysiwygApi(api)" />\
            <hr>\
