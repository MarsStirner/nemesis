	  ...
	  '$templateCache', function($templateCache) {
	    return {
	      ...
	      template: function(el, attrs) {
	        ...
	        _ref = el.prop("attributes");
	        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
	          attr = _ref[_i];
	          formAttributes[attr.name] = attr.value;
	        }
	        inputReplacer = function(el) {
	          var attributes, input, inputEl, label, name, type, _j, _len1, _ref1;
	          ...
	          return inputTpl.replace(/::name/g, name).replace(/::label/g, label).replace(/::content/, inputEl[0].outerHTML);
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module(["ng"]).run(["$templateCache",function(c){c.put("templates/fs/metaRadio.html", v1)}]);
	module.exports=v1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module(["ng"]).run(["$templateCache",function(c){c.put("templates/fs/list.html", v1)}]);
	module.exports=v1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module(["ng"]).run(["$templateCache",function(c){c.put("templates/fs/metaCheckbox.html", v1)}]);
	module.exports=v1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module(["ng"]).run(["$templateCache",function(c){c.put("templates/fs/metaInput.html", v1)}]);
	module.exports=v1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module(["ng"]).run(["$templateCache",function(c){c.put("templates/fs/metaRow.html", v1)}]);
	module.exports=v1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module(["ng"]).run(["$templateCache",function(c){c.put("templates/fs/errors.html", v1)}]);
	module.exports=v1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module(["ng"]).run(["$templateCache",function(c){c.put("templates/fs/metaSelect.html", v1)}]);
	module.exports=v1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module(["ng"]).run(["$templateCache",function(c){c.put("templates/fs/multiselect.html", v1)}]);
	module.exports=v1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module(["ng"]).run(["$templateCache",function(c){c.put("templates/fs/time.html", v1)}]);
	module.exports=v1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var v1="<div class=\"fs-date fs-widget-root\"> <input fs-input fs-focus-when=\"active\" fs-blur-when=\"!active\" fs-on-focus=\"active = true\" fs-on-blur=\"active = false\" fs-hold-focus fs-esc=\"active = false\" type=\"text\" ng-disabled=\"disabled\" class=\"form-control\" ng-model=\"selectedDate.date\" fs-date-format=\"{{format}}\" placeholder=\"{{placeholder}}\" fs-null-form/>\n<span class=\"glyphicon glyphicon-calendar\" ng-click=\"active = !disabled\"></span> <div ng-if=\"!disabled && active\" class=\"open fs-calendar-wrapper\"> <div class=\"dropdown-menu\"> <fs-calendar ng-model=\"selectedDate.date\" on-select=\"close()\" first-day-of-week=\"1\"/> </div> </div> </div>";
	angular.module(["ng"]).run(["$templateCache",function(c){c.put("templates/fs/date.html", v1)}]);
	module.exports=v1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module(["ng"]).run(["$templateCache",function(c){c.put("templates/fs/calendar.html", v1)}]);
	module.exports=v1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module(["ng"]).run(["$templateCache",function(c){c.put("templates/fs/datetime.html", v1)}]);
	module.exports=v1;
