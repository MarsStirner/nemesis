            ...
            if ( data ) {
              ...
              nv.addGraph( {
                generate: function () {
                  ...
                  } : scope.description() ).color( attrs.color === undefined ? nv.utils.defaultColor() : scope.color() ).donutLabelsOutside( attrs.donutLabelsoOutside === undefined ? false : attrs.donutLabelsOutside === 'true' ).donut( attrs.donut === undefined ? false : attrs.donut === 'true' ).donutRatio( attrs.donutRatio === undefined ? 0.5 : attrs.donutRatio );
                  if ( attrs.tooltipcontent ) {
                    chart.tooltipContent( scope.tooltipcontent() );
                  }
                  scope.d3Call( data, chart );
