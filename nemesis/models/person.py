...
class Person(db.Model):
    ...
    login = db.Column(db.Unicode(32), nullable=False, default='')
    password = db.Column(db.String(32), nullable=False)
    userProfile_id = db.Column(db.Integer, index=True)
    retired = db.Column(db.Integer, nullable=False)
    birthDate = db.Column(db.Date, nullable=True)  # для интеграции с Тулой сняли обязательность
    ...
    events_under_control = db.relationship('EventPersonsControl', back_populates='person', lazy='dynamic')
...
class rbSpeciality(db.Model):
    ...
    OKSOName = db.Column(db.Unicode(60), nullable=False, default='')
    OKSOCode = db.Column(db.String(8), nullable=False, default='')
    service_id = db.Column(db.ForeignKey('rbService.id'), index=True)
    sex = db.Column(db.Integer, nullable=False, default=0)
    age = db.Column(db.String(9), nullable=False, default='')
    age_bu = db.Column(db.Integer)
    age_bc = db.Column(db.SmallInteger)
    age_eu = db.Column(db.Integer)
    age_ec = db.Column(db.SmallInteger)
    mkbFilter = db.Column(db.String(32), nullable=False, default='')
    regionalCode = db.Column(db.String(16), nullable=False, default='')
...
class rbPost(db.Model):
    ...
    code = db.Column(db.String(8), nullable=False, index=True)
    name = db.Column(db.Unicode(64), nullable=False, index=True)
    regionalCode = db.Column(db.String(8), nullable=False, default='')
    key = db.Column(db.String(6), nullable=False, index=True, default='')
    high = db.Column(db.String(6), nullable=False, default='')
    flatCode = db.Column(db.String(65), nullable=False, default='')
    deleted = db.Column(db.SmallInteger, nullable=False, server_default='0')
